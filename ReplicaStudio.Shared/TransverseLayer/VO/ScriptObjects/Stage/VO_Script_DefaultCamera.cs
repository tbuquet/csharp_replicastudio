...
{
    [Serializable]
    public class VO_Script_DefaultCamera : VO_Line, IScriptable
    {
        #region Properties
        #endregion

        #region Constructor
        public VO_Script_DefaultCamera()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, "Default Camera");
