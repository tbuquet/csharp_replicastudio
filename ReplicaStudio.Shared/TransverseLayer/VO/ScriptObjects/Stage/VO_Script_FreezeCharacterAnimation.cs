...
{
    [Serializable]
    public class VO_Script_FreezeCharacterAnimation : VO_Line, IScriptable
    {
        #region Properties
        ...
        #region Constructor
        public VO_Script_FreezeCharacterAnimation()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            if (FreezeAll == true)
            {
                TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, "Freeze all Animations of Character ");
            ...
            {
                TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, "Freeze Animation ");
