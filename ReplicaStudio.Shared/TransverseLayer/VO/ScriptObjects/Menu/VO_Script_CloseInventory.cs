...
{
    [Serializable]
    public class VO_Script_CloseInventory : VO_Line, IScriptable
    {
        #region Properties
        #endregion

        #region Constructor
        public VO_Script_CloseInventory()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_RED, "Close");
