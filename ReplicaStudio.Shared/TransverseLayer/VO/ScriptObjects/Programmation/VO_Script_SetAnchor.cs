...
{
    [Serializable]
    public class VO_Script_SetAnchor : VO_Line, IScriptable
    {
        #region Properties
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_ORANGE, "Set");
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, " Anchor ");
