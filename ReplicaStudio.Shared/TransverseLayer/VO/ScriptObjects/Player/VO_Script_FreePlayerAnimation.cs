...
{
    [Serializable]
    public class VO_Script_FreePlayerAnimation : VO_Line, IScriptable
    {
        #region Properties
        ...
        #region Constructor
        public VO_Script_FreePlayerAnimation()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            if (FreeAll == true)
            {
                TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_GREEN, "Free");
