...
{
    [Serializable]
    public class VO_Script_StopCurrentPlayerMovement : VO_Line, IScriptable
    {
        #region Properties
        #endregion

        #region Constructor
        public VO_Script_StopCurrentPlayerMovement()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, " current player movement");
