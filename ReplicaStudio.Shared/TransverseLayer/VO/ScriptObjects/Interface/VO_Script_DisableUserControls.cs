...
{
    [Serializable]
    public class VO_Script_DisableUserControls : VO_Line, IScriptable
    {
        #region Properties
        #endregion

        #region Constructor
        public VO_Script_DisableUserControls()
        {
        }
        #endregion
        ...
        public List<TreeNode> RenderInScriptManager(string code)
        {
            ...
            TextColor.AddNewColorAndText(GlobalConstants.TREEVIEW_BLACK, " UserControls");
